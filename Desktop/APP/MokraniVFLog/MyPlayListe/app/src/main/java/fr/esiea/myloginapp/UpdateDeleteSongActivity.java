            ...
            public void onClick(View v) {
                ...
                new FirebaseDatabaseBHelper().updateSong(key, song, new FirebaseDatabaseBHelper.DataStatus() {
                    ...
                    public void DataIsUpdated() {
                        Toast.makeText(UpdateDeleteSongActivity.this, "L'enregistrement de morceau " + "a été mis à jour avec succès ", Toast.LENGTH_LONG).show();
        ...
        mDelete_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new FirebaseDatabaseBHelper().deleteSong(key, new FirebaseDatabaseBHelper.DataStatus() {
                    ...
                    @Override
                    public void DataIsDeleted() {
                        Toast.makeText(UpdateDeleteSongActivity.this, "L'enregistrement de morceau  " + "a été supprimé avec succès ", Toast.LENGTH_LONG).show();
                        finish();
                        return;
