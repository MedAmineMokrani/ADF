        ...
        mAdd_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new FirebaseDatabaseBHelper().addSong(song, new FirebaseDatabaseBHelper.DataStatus() {
                    @Override
                    public void DataIsLoaded(List<fr.esiea.myloginapp.song> Songs, List<String> Keys) {

                    }

                    @Override
                    public void DataIsInserted() {
                        Toast.makeText(NewSongActivity.this, " La chanson a " + "été enregistrer avec succées ", Toast.LENGTH_LONG).show();
                    }
